...
ROOT_URLCONF = 'sleek_main_hub.urls'
...
WSGI_APPLICATION = 'sleek_main_hub.wsgi.application'
TIME_ZONE = 'UTC'
# Database
...
MBOA_ID_ROOT = os.path.join(BASE_DIR, 'sleek_keys_logs')
...
MPESA_SHORTCODE = config('MPESA_SHOTCODE')
